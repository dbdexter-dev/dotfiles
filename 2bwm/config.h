...
#define NO_MOD			0x000000

#define RAISEVOL		0x1008ff13
#define MUTEVOL			0x1008ff12
#define LOWERVOL		0x1008ff11
#define RAISEBRI		0x1008ff02
#define LOWERBRI		0x1008ff03
...
static const uint8_t offsets[] = {BORDER,BORDER+BAR_SIZE,BORDER*2,BORDER*2+BAR_SIZE};
///---Colors---///
/*0)focuscol         1)unfocuscol
 *2)fixedcol         3)unkilcol
 *4)fixedunkilcol    5)outerbordercol
 *6)emptycol         */
static const char *colors[] = {"#55bbcc","#2e3440","#dd8855","#2e3440","#2e3440","#2e3440","#2e3440"};
...
static const uint8_t borders[] = {1,2,2,2};
...
///--Menus and Programs---///
static const char *menucmd[]   = { "rofi", "-show", "run", "-modi", "\"run,man:~/.config/rofi/man,window\"", NULL };
static const char *termcmd[]   = { "urxvt", NULL };
static const char *lockscreen[]= { "bash", "-c", "~/.config/herbstluftwm/lock.sh", NULL };
...
static const char *brightnessRaise[]   = { "bash", "-c", "~/.config/herbstluftwm/backlight up", NULL };
static const char *brightnessLower[]   = { "bash", "-c", "~/.config/herbstluftwm/backlight down", NULL };
///--Custom foo---///
...
static key keys[] = {
	...
	// Volume controls
	{	NO_MOD,			RAISEVOL,		start,		{.com = volumeRaise}},
	{	NO_MOD,			MUTEVOL,		start,		{.com = volumeMute}},
	{	NO_MOD,			LOWERVOL,		start,		{.com = volumeLower}},
	{	NO_MOD,			RAISEBRI,		start,		{.com = brightnessRaise}},
	{	NO_MOD,			LOWERBRI,		start,		{.com = brightnessLower}},
    // Iconify the window
    //{  MOD ,              XK_i,          hide,              {}},
