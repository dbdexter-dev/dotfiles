...
let s:p.normal.error = [ [ s:baseLightest, s:red ] ]
let s:p.normal.warning = [ [ s:baseLightest, s:red ] ]
...
let s:p.insert.left = [ [ s:baseDarkest, s:orange ], [ s:baseLightest, s:baseDark ], [ s:orange, s:baseDarkest ] ]
let s:p.insert.right = [ [ s:baseDarkest, s:orange ], [ s:baseLightest, s:baseDark ], [ s:orange, s:baseDarkest ] ]
