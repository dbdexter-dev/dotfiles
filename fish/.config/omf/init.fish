...
set -g __color_path_nowrite             magenta black
set -g __color_path_nowrite_basename    magenta black --bold
...
set -g __color_vi_mode_insert           yellow black
set -g __color_vi_mode_visual           green black
